...
namespace PrimeFuncPack.Tests
{
    ...
    {
        [Fact]
        public void CreateFromResolver_SingleIsNull_ExpectArgumentNullException()
        {
        ...
        public void CreateFromResolver_SingleIsNotNull_ExpectResolvedValueIsEqualToSource(
