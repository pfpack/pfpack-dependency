...
namespace PrimeFuncPack.Tests
{
    partial class EightDependencyTest
    {
        ...
        [Fact]
        public void CreateFromResolver_FourthIsNull_ExpectArgumentNullException()
        {
        ...
        [Fact]
        public void CreateFromResolver_FifthIsNull_ExpectArgumentNullException()
        {
            var first = false;
        ...
        [Fact]
        public void CreateFromResolver_SixthIsNull_ExpectArgumentNullException()
        {
        ...
        [Fact]
        public void CreateFromResolver_SeventhIsNull_ExpectArgumentNullException()
        {
        ...
        [Fact]
        public void CreateFromResolver_RestIsNull_ExpectArgumentNullException()
        {
