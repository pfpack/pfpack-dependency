    ...
    partial class EightDependencyTest
    {
        ...
        public void Create_FirstIsNull_ExpectArgumentNullException()
        {
            ...
            var ex = Assert.Throws<ArgumentNullException>(
                () => _ = Dependency<bool?, string, decimal, RecordType?, object, StructType, DateTimeKind?, RefType>.Create(
                    null!,
                    () => second,
                    () => third,
                    () => fourth,
        ...
        public void Create_SecondIsNull_ExpectArgumentNullException()
        {
            ...
            var ex = Assert.Throws<ArgumentNullException>(
                () => _ = Dependency<RefType, RecordType, long, object, StructType?, string?, decimal, DateTimeKind>.Create(
                    () => first,
                    null!,
                    () => third,
                    () => fourth,
        ...
        public void Create_ThirdIsNull_ExpectArgumentNullException()
        {
            ...
            var ex = Assert.Throws<ArgumentNullException>(
                () => _ = Dependency<object, StructType, DateTime, string?, RecordType?, decimal?, RefType, bool>.Create(
                    () => first,
                    () => second,
                    null!,
                    () => fourth,
        ...
        public void Create_FourthIsNull_ExpectArgumentNullException()
        {
            ...
            var ex = Assert.Throws<ArgumentNullException>(
                () => _ = Dependency<string, object, RecordType?, double, StructType, RefType, int, long?>.Create(
                    () => first,
                    () => second,
                    () => third,
                    null!,
        ...
        public void Create_FifthIsNull_ExpectArgumentNullException()
        {
            ...
            var ex = Assert.Throws<ArgumentNullException>(
                () => _ = Dependency<StructType, decimal, RefType?, RecordType?, string?, bool, DateTimeKind, object?>.Create(
                    () => first,
                    () => second,
                    () => third,
                    () => fourth,
        ...
        public void Create_SixthIsNull_ExpectArgumentNullException()
        {
            ...
            var ex = Assert.Throws<ArgumentNullException>(
                () => _ = Dependency<int, RefType, RecordType?, long, object, StructType, string?, decimal>.Create(
                    () => first,
                    () => second,
                    () => third,
                    () => fourth,
        ...
        [Fact]
        public void Create_SeventhIsNull_ExpectArgumentNullException()
        {
            ...
            var ex = Assert.Throws<ArgumentNullException>(
                () => _ = Dependency<decimal?, bool, object, long[], StructType, RecordType?, RefType?, DateTimeKind>.Create(
                    () => first,
                    () => second,
                    () => third,
                    () => fourth,
        ...
        [Fact]
        public void Create_RestIsNull_ExpectArgumentNullException()
        {
            ...
            var ex = Assert.Throws<ArgumentNullException>(
                () => _ = Dependency<object?, string, StructType, RefType, bool?, RecordType, DateTimeKind, long?>.Create(
                    () => first,
                    () => second,
                    () => third,
                    () => fourth,
            ...
            string? sourceRest)
        {
            ...
            var actual = Dependency<StructType, RefType, object?, bool, int?, RecordType, long, string?>.Create(
                () => sourceFirst,
                () => sourceSecond,
                () => sourceThird,
                () => sourceFourth,
