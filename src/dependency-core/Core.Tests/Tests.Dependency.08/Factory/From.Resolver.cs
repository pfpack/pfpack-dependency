    ...
    partial class EightDependencyTest
    {
        ...
        public void From_Resolver_FirstIsNull_ExpectArgumentNullException()
        {
            ...
            var ex = Assert.Throws<ArgumentNullException>(
                () => _ = Dependency<RefType, RecordType, int, object, StructType, decimal, bool, string>.From(
                    null!,
                    _ => second,
                    _ => third,
                    _ => fourth,
        ...
        public void From_Resolver_SecondIsNull_ExpectArgumentNullException()
        {
            ...
            var ex = Assert.Throws<ArgumentNullException>(
                () => _ = Dependency<DateTimeKind, StructType, string, int?, RefType, decimal, bool, object>.From(
                    _ => first,
                    null!,
                    _ => third,
                    _ => fourth,
        ...
        public void From_Resolver_ThirdIsNull_ExpectArgumentNullException()
        {
            ...
            var ex = Assert.Throws<ArgumentNullException>(
                () => _ = Dependency<int, RefType?, string, long?, bool?, object?, StructType, RecordType>.From(
                    _ => first,
                    _ => second,
                    null!,
                    _ => fourth,
        ...
        public void From_Resolver_FourthIsNull_ExpectArgumentNullException()
        {
            ...
            var ex = Assert.Throws<ArgumentNullException>(
                () => _ = Dependency<StructType?, string[]?, object, RecordType?, DateTimeKind, decimal?, bool, RefType>.From(
                    _ => first,
                    _ => second,
                    _ => third,
                    null!,
        ...
        public void From_Resolver_FifthIsNull_ExpectArgumentNullException()
        {
            ...
            var ex = Assert.Throws<ArgumentNullException>(
                () => _ = Dependency<bool, RecordType?, int, StructType, object[], long?, RefType, string>.From(
                    _ => first,
                    _ => second,
                    _ => third,
                    _ => fourth,
        ...
        public void From_Resolver_SixthIsNull_ExpectArgumentNullException()
        {
            ...
            var ex = Assert.Throws<ArgumentNullException>(
                () => _ = Dependency<RecordType, DateTimeKind, string?, object, StructType, decimal, int, RefType?>.From(
                    _ => first,
                    _ => second,
                    _ => third,
                    _ => fourth,
        ...
        public void From_Resolver_SeventhIsNull_ExpectArgumentNullException()
        {
            ...
            var ex = Assert.Throws<ArgumentNullException>(
                () => _ = Dependency<StructType?, long, DateTimeKind, bool?, RecordType, RefType, decimal[]?, string>.From(
                    _ => first,
                    _ => second,
                    _ => third,
                    _ => fourth,
        ...
        [Fact]
        public void From_Resolver_RestIsNull_ExpectArgumentNullException()
        {
            ...
            var ex = Assert.Throws<ArgumentNullException>(
                () => _ = Dependency<decimal, object, RecordType, string?, int?, StructType, RefType?, DateTimeKind>.From(
                    _ => first,
                    _ => second,
                    _ => third,
                    _ => fourth,
            ...
            StructType sourceRest)
        {
            ...
            var actual = Dependency<object, string?, RecordType?, int, DateTimeOffset?[], long, RefType, StructType>.From(
                _ => sourceFirst,
                _ => sourceSecond,
                _ => sourceThird,
                _ => sourceFourth,
