...
namespace PrimeFuncPack.Tests
{
    ...
    {
        [Fact]
        public void CreateFromResolver_01_SingleIsNull_ExpectArgumentNullException()
        {
        ...
        public void CreateFromResolver_01_SingleResolverIsNotNull_ExpectResolvedValueIsEqualToSource(
