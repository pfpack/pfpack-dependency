...
namespace PrimeFuncPack.Tests
{
    ...
    {
        [Fact]
        public void CreateFromResolver_03_FirstIsNull_ExpectArgumentNullException()
        {
        ...
        [Fact]
        public void CreateFromResolver_03_SecondIsNull_ExpectArgumentNullException()
        {
        ...
        [Fact]
        public void CreateFromResolver_03_ThirdIsNull_ExpectArgumentNullException()
        {
        ...
        public void CreateFromResolver_03_ResolversAreNotNull_ExpectResolvedValuesAreEqualToSource(
