...
namespace PrimeFuncPack.Tests
{
    ...
    {
        [Fact]
        public void CreateFromResolver_07_FirstIsNull_ExpectArgumentNullException()
        {
        ...
        [Fact]
        public void CreateFromResolver_07_SecondIsNull_ExpectArgumentNullException()
        {
        ...
        [Fact]
        public void CreateFromResolver_07_ThirdIsNull_ExpectArgumentNullException()
        {
        ...
        [Fact]
        public void CreateFromResolver_07_FourthIsNull_ExpectArgumentNullException()
        {
        ...
        [Fact]
        public void CreateFromResolver_07_FifthIsNull_ExpectArgumentNullException()
        {
            var first = MinusFifteenIdRefType;
        ...
        [Fact]
        public void CreateFromResolver_07_SixthIsNull_ExpectArgumentNullException()
        {
        ...
        [Fact]
        public void CreateFromResolver_07_SeventhIsNull_ExpectArgumentNullException()
        {
            var first = SomeTextStructType;
        ...
        public void CreateFromResolver_07_ResolversAreNotNull_ExpectResolvedValuesAreEqualToSource(
