...
namespace PrimeFuncPack.Tests
{
    ...
    {
        [Fact]
        public void CreateFromFactory_08_FirstIsNull_ExpectArgumentNullException()
        {
        ...
        [Fact]
        public void CreateFromFactory_08_SecondIsNull_ExpectArgumentNullException()
        {
        ...
        [Fact]
        public void CreateFromFactory_08_ThirdIsNull_ExpectArgumentNullException()
        {
        ...
        [Fact]
        public void CreateFromFactory_08_FourthIsNull_ExpectArgumentNullException()
        {
            var first = true;
        ...
        [Fact]
        public void CreateFromFactory_08_FifthIsNull_ExpectArgumentNullException()
        {
        ...
        [Fact]
        public void CreateFromFactory_08_SixthIsNull_ExpectArgumentNullException()
        {
        ...
        [Fact]
        public void CreateFromFactory_08_SeventhIsNull_ExpectArgumentNullException()
        {
        ...
        [Fact]
        public void CreateFromFactory_08_RestIsNull_ExpectArgumentNullException()
        {
            var first = true;
        ...
        public void CreateFromFactory_08_FactoriesAreNotNull_ExpectResolvedValuesAreEqualToSource(
            RefType sourceRest)
        {
